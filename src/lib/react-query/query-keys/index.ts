...
export { nhomApDoanhSo, nhomApDoanhSo as nhomApDoanhSoQueryKeys } from "./nhom-ap-doanh-so"
export { dangKyDoanhSo, dangKyDoanhSo as dangKyDoanhSoQueryKeys } from "./dang-ky-doanh-so"
