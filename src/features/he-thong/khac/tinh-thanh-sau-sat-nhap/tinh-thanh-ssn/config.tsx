/**
 * Module Configuration for Tỉnh thành SSN
 */

import { ModuleConfig } from "@/shared/types/module-config"

export const tinhThanhSSNConfig: ModuleConfig = {
  // Basic info
  moduleName: "tinh-thanh-ssn",
  moduleTitle: "Tỉnh thành SSN",
  moduleDescription: "Quản lý tỉnh thành sau sát nhập",
  
  // Routing
  routePath: "/he-thong/tinh-thanh-ssn",
  parentPath: "/he-thong",
