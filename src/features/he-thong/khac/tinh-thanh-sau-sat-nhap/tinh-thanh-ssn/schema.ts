...
/**
 * Schema matching 'var_ssn_tinh_thanh' table in Supabase
 */
export const tinhThanhSSNSchema = z.object({
...
export type TinhThanhSSN = z.infer<typeof tinhThanhSSNSchema>

/**
 * Schema for creating new tỉnh thành SSN
 */
export type CreateTinhThanhSSNInput = Omit<TinhThanhSSN, "id" | "tg_tao" | "tg_cap_nhat">

/**
 * Schema for updating tỉnh thành SSN
 */
export type UpdateTinhThanhSSNInput = Partial<Omit<TinhThanhSSN, "id" | "tg_tao">>
