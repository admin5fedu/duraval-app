...
import type { BatchPhieuDeXuatBanHangOperationResult } from "../schema"
import { PhieuDeXuatBanHangService } from "../services/phieu-de-xuat-ban-hang-service"
...
const service = new PhieuDeXuatBanHangService()

/**
 * Hook for batch upsert (import) phiếu đề xuất bán hàng from Excel
 */
export function useBatchUpsertPhieuDeXuatBanHang() {
  const queryClient = useQueryClient()

  return useMutation({
    mutationFn: async (records: Partial<PhieuDeXuatBanHang>[]): Promise<BatchPhieuDeXuatBanHangOperationResult> => {
      let inserted = 0
      let updated = 0
