...
export function FormFieldRenderer({ field, form, mode = "page" }: FormFieldRendererProps) {
    ...
    return (
        <FormField
            ...
            render={({ field: formField }) => {
                // Determine colSpan based on mode
                let colSpanClass = "col-span-1"

                if (mode === "drawer") {
                    // Drawer Layout
                    if (field.colSpan && field.colSpan >= 2) {
                    ...
                    // Page/Popup Layout (3 columns logic)
                    if (field.colSpan === 2) colSpanClass = "md:col-span-2"
                    if (field.colSpan === 3) colSpanClass = "md:col-span-2 lg:col-span-3"
                }
                    ...
                    <FormItem className={colSpanClass}>
                        <div className={cn(
                            ...
                            <FormLabel className={cn(
                                ...
                                // Drawer mode specific label styling (smaller, gray)
                                mode === "drawer" && "text-xs font-semibold text-gray-500 uppercase tracking-wide"
                            )}>
