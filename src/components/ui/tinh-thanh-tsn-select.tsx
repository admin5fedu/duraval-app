...
import { useTinhThanhTSNForReference } from "@/features/he-thong/khac/tinh-thanh-truoc-sat-nhap/tinh-thanh-tsn/hooks"
import { Skeleton } from "@/components/ui/skeleton"

export interface TinhThanhTSNSelectProps {
...
/**
 * Component chọn tỉnh thành TSN với ô search
 * Reusable UI component - có thể dùng chung trong toàn bộ ứng dụng
 */
export const TinhThanhTSNSelect = React.forwardRef<HTMLButtonElement, TinhThanhTSNSelectProps>(
function TinhThanhTSNSelect({
    value,
    onChange,
    ...
    // Fetch danh sách tỉnh thành TSN (reference data - cached for 30 minutes)
    const { data: tinhThanhList, isLoading } = useTinhThanhTSNForReference()
...
TinhThanhTSNSelect.displayName = "TinhThanhTSNSelect"
